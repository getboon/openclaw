...
export function extractDurableInstructionProposal(params: {
  ...
  return {
    ...
    content: [
      ...
      "## TLDR",
      "",
      `This skill captures reusable guidance for ${topic.label}.`,
      "",
      "When you run this, the agent will:",
      "",
      "- Review the request for the applicable workflow.",
      "- Apply the captured guidance and known pitfalls.",
      "- Verify the result before returning it.",
      "",
      `**Output:** A completed ${topic.label} result that follows the captured guidance.`,
      "",
      "## Workflow",
      "",
      `- ${instruction}`,

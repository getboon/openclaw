...
| `after_tool_call`  | `error` is set and `errorKind !== "denied"`                 | `tool`, `error_kind`, `error_code`                                                       |

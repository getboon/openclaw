...
- **[diagnostics-otel](/plugins/reference/diagnostics-otel)** (`@openclaw/diagnostics-otel`) - included in OpenClaw. OpenClaw diagnostics OpenTelemetry exporter for metrics, traces, and logs.
